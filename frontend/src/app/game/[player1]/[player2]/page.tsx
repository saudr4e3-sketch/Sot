 ...
 * Version: 6.0.0 - Self-Healing Timer, Offline Resilience, Auto-Advance Engine
 * ============================================================================
 */
...
export default function GamePage() {
  ...
  const advanceLocally = useCallback(() => {
    ...
    const isFinished = nextIndex >= (currentState.total_positions ?? TOTAL_AUCTION_POSITIONS)
  ...
  }, [send, sessionId, player1Id, isConnected, addLog, setIsLoading])
    ...
    <main className="min-h-screen bg-dark-bg text-text-primary selection:bg-accent-terracotta selection:text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-emerald-500/10 text-emerald-400 text-[10px] font-bold px-2 py-0.5 rounded-full border border-emerald-500/20">v6.0</span>
              </div>
              <p className="text-xs text-text-secondary">Self-Healing Auction Engine</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <AuctionTimer
              ...
              currentPlayer={safeState.current_player as any}
      ...
      <footer className="bg-dark-bg-alt border-t border-dark-card mt-12 py-8">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4">
          <div>
            <p className="text-text-primary font-bold text-sm">OSM FUT Dual Battle Engine v6.0</p>
